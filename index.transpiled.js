...
window.generateHousehold = function() {
  ...
  for (var name in categories) {
    var total = categories[name].reduce(
      function (acc, curr) { return (acc += curr.weight); },
      0
    );
    var randomWeight = Number.parseInt(Math.random() * total);
    for (var i = 0; randomWeight > 0; i++) {
